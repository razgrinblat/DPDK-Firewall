...
static const pcpp::IPv4Address DPDK_DEVICE2_IP("172.20.10.8"); // "192.168.1.22" or "172.20.10.8" in HOTSPOT
static const pcpp::IPv4Address ROUTER_IP("172.20.10.1"); // 192.168.1.1 or 172.20.10.1 in HOTSPOT

//SUBNET MASK
static const pcpp::IPv4Address SUBNET_MASK("255.255.255.240"); //255.255.255.0 or 255.255.255.240 in HOTSPOT

//MAC ADDRESSES
static const pcpp::MacAddress CLIENT_MAC_ADDRESS("08:00:27:42:82:3b");
static const pcpp::MacAddress ROUTER_MAC_ADDRESS("fa:87:f1:1a:09:64"); // "b4:ee:b4:a9:f7:e1" or "fa:87:f1:1a:09:64" in HOTSPOT
